...
// 		}
	...
	public function lop10Action() {
		...
		if (null === $this->_getParam('id')) {
			// Get list submajors
			$subMajorsObj = Submajors::getInstance()->getSubmajorsByClassIdMajorId(Constants::LOP_10, Constants::ID_DIA_LY);
	...
	public function lop11Action() {
		...
		if (null === $this->_getParam('id')) {
			// Get list submajors
			$subMajorsObj = Submajors::getInstance()->getSubmajorsByClassIdMajorId(Constants::LOP_11, Constants::ID_DIA_LY);
			$this->_helper->viewRenderer('index');
			$this->view->subMajors = $subMajorsObj;
			return;
		}
	...
	public function lop12Action() {
		...
		if (null === $this->_getParam('id')) {
			// Get list submajors
			$subMajorsObj = Submajors::getInstance()->getSubmajorsByClassIdMajorId(Constants::LOP_12, Constants::ID_DIA_LY);
			$this->_helper->viewRenderer('index');
			$this->view->subMajors = $subMajorsObj;
			return;
		}
