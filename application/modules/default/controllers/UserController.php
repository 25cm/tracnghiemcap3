...
class UserController extends Controller {
    ...
    public function doAddedAction(){
        ...
        $db->beginTransaction();
        try {
        	Log::infoLog('Insert user method='.__FUNCTION__.';user_id='.$user->user_id.';End action;',$this->getRequest()->getParams());
            ...
            $db->rollBack();
            Log::errorLog('Error log method='.__FUNCTION__.';user_id='.$user->user_id.';End action;',$this->getRequest()->getParams());
    ...
    public function doEditAction(){
        ...
        $db->beginTransaction();
        try {
        	Log::infoLog('Edit user method='.__FUNCTION__.';user_id='.$user->user_id.';End action;',$this->getRequest()->getParams());
            $now = Zynas_Date::dbDatetime();
    ...
    public function deleteAction() {
        ...
        try {
            ...
            $row->save();
            Log::infoLog('Delete user method='.__FUNCTION__.';user_id='.$user->user_id.';End action;',$this->getRequest()->getParams());
            $db->commit();
