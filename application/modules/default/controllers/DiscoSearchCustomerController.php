...
class DiscoSearchCustomerController extends Controller
{
    ...
    public function listAction()
    {
        ...
        Log::infoLog('method='.__FUNCTION__.';user_id='.$userId.';Start action;',$this->getRequest()->getParams());
        ...
        Log::infoLog('method='.__FUNCTION__.';user_id='.$userId.';End action;',$this->getRequest()->getParams());
    }
