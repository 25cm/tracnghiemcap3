...
class DaIssuedHistController extends Controller {
    ...
    public function downloadAction() {
        ...
        Log::infoLog('method='.__FUNCTION__.';user_id='.$user->user_id.';File name='.$file_name.';End action;',$this->getRequest()->getParams());
    }
    ...
    public function addCustomerAction() {
        ...
        Log::infoLog('method='.__FUNCTION__.';user_id='.$user->user_id.';Customer code='.$customerCode.';End action;',$this->getRequest()->getParams());
    }
